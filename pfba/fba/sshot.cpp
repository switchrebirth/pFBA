...
int MakeScreenShot(const char *dest) {
    ...
    text_ptr[4].text = szSoftware;
    text_ptr[5].key = "Source";
    text_ptr[5].text = szSource;
    text_ptr[6].key = "Comment";
    text_ptr[6].text = "This screenshot was created by running the game in an emulator; it might not accurately reflect the actual hardware the game was designed to run on.";
